...
def look_up(add_book, name):
    ...
    return add_book.get(name, f"ERROR: No entry for {name} found.")
...
def edit(add_book, name, new_address):
    ...
    if name in add_book:
        ...
        print(f"\n{name} is not in the address book.\n")
...
def delete(add_book, name):
    ...
    if name in add_book:
        ...
        print(f"\nI can't do that! {name} doesn't exist in the address book.\n")


def list_all(add_book):
    """prints out all the addresses
    e.g. address_book = {"Sam": "MS308, Markeaton St, Derby",
    ...
    while choice != "0":
        ...
        # delete a name-address pair
            ...
            if name_to_del in address_book:
                ...
                print(f"\nI can't do that! {name_to_del} doesn't exist in theaddress book.\n")
        elif choice == "5":
